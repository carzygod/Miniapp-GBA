...
import {shareLocalFile} from '../../platform/local-files'
import './index.scss'
...
export default function DiagnosticsPage(){
  ...
  const exportPackage=async()=>{const current=buildDiagnosticPackage(),path=`${dataRoot}/exports/minigba-diagnostics-${Date.now()}.json`;await writeTextAtomic(path,JSON.stringify(current,null,2));await shareLocalFile(path,'minigba-diagnostics.json')}
