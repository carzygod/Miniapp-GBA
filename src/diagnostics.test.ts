...
vi.mock('@tarojs/taro',()=>({default:{getStorageSync:(key:string)=>storage.get(key),setStorageSync:(key:string,value:unknown)=>storage.set(key,value),getSystemInfoSync:()=>({SDKVersion:'3.6.0',platform:'ios',system:'iOS 18',model:'Phone'})}}))
