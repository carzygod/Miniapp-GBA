...
const emptyUsage:StorageUsage={roms:0,batterySaves:0,stateSaves:0,screenshots:0,temporary:0,quarantine:0,other:0,total:0}
...
export default function StoragePage(){
  ...
  const rows:[string,number,string][]=[['ROM',usage.roms,'正式游戏文件'],['电池存档',usage.batterySaves,'SRAM / Flash / EEPROM'],['状态存档',usage.stateSaves,'手动槽与自动恢复点'],['截图',usage.screenshots,'本地画面截图'],['临时文件',usage.temporary,'可安全清理'],['隔离文件',usage.quarantine,'校验失败内容'],['其他',usage.other,'索引与同步元数据']]
